...
<body>
    ...
    <h1 class="titulo">Oops! Não foi possível acessar está página, entre com seus dados para acessar!</h1>

    <div class="container">
        <div class="row">
            <div class="col s12 painel">
                <div class="col s12 button-center">
                    <a href="../php/actions/logout.php" class="waves-effect waves-light btn botaoVoltar">
                        Voltar
                    </a>
                </div>
