...
try {
    ...
    if ($stmt->execute()) {
        foreach ($stmt as $res) :
            ...
            echo "<a href=\"../php/cozinha/update_cozinha.php?id=$iditens.\" class='btn-floating btn-small waves-effect waves-light green iconebotao' ><i class='material-icons'>done</i></a> ";
            echo '</td>';
            echo '</tr>';
            echo '</td>';
            echo '</tr>';
